...
public class HomeIngresosGridAdapter extends BaseAdapter {

    private Context context;
    private ArrayList<CategoriaIngreso> arrayList;


    public HomeIngresosGridAdapter(Context context, ArrayList<CategoriaIngreso> arrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        CategoriaIngreso catIngreso = arrayList.get(position);
