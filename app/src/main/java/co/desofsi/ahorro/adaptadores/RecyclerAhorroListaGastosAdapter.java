...
import co.desofsi.ahorro.entidades.Ahorro;
...
public class RecyclerAhorroListaGastosAdapter extends RecyclerView.Adapter<ViewHolderGastosPresupuesto> {

    private ArrayList<Ahorro> listDatos;


    public RecyclerAhorroListaGastosAdapter(ArrayList<Ahorro> listDatos) {
