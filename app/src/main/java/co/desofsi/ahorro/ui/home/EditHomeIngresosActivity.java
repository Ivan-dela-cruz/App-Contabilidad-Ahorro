...
public class EditHomeIngresosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_home_ingresos);
        ActionBar actionBar = getSupportActionBar();
        actionBar.setTitle("Editar Ingreso");
        ...
        final Ingresos cate = (Ingresos) getIntent().getExtras().getSerializable("Ingreso");
        ...
        btn_eliminar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder aletBuilder = new AlertDialog.Builder(EditHomeIngresosActivity.this);
                ...
                aletBuilder.setPositiveButton("Si", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent intent = new Intent(EditHomeIngresosActivity.this, MainActivity.class);
            ...
            public void onClick(View v) {
                ...
                aletBuilder.setPositiveButton("Si", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        MainActivity.sqLiteHelper.updateDataTableIngresos(cate.getId(),txt_nombre.getText().toString(),Double.parseDouble(decimalFormat.format(valor_choose)),txt_fecha.getText().toString());
        ...
        txt_fecha.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(EditHomeIngresosActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
    ...
    public void init() {
        btn_actualizar = (Button) findViewById(R.id.btn_edit_ingreso_acutualizar);
        btn_eliminar = (Button) findViewById(R.id.btn_edit_ingreso_eliminar);
        txt_position = (TextView) findViewById(R.id.text_position);
        imageView = (ImageView) findViewById(R.id.txt_edit_ingreso_imagen);
        txt_nombre = (EditText) findViewById(R.id.txt_edit_ingreso_description);
        txt_presupuesto = (EditText) findViewById(R.id.txt_edit_ingreso_valor);
        txt_fecha = (EditText) findViewById(R.id.txt_edit_ingreso_fecha);
